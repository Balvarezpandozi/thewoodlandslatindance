      ...
      Array.prototype.filter.call(forms, function (form) {
        form.addEventListener(
          ...
          function (event) {
            ...
            const invalidAreaCode =
              areaCode[0] == "0" || areaCode[0] == "1" || areaCode[1] == "9";
            //US rules for invalid exchange code
            const invalidExchangeCode =
              exchangeCode[0] == "0" || exchangeCode[0] == "1";
            if (
              ...
              phoneInput.setCustomValidity(
                "Enter a valid phone number. Just the digits. Ex: 5555555555"
              );
              isValid = false;
            } else {
              phoneInput.setCustomValidity("");
